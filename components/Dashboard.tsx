...
const Dashboard: React.FC = () => {
  ...
  const handleCloseModal = () => {
    ...
    setEditingSet(null); // This is the crucial fix
  };
      ...
      <div className="lg:col-span-2">
        ...
        {userSets.length === 0 ? (
          <div className="text-center py-16 px-6 bg-white rounded-lg shadow-md border-2 border-dashed border-gray-300">
            ...
            <p className="mt-2 text-gray-500">Your learning journey begins here. Click the button above to start building your collection of words.</p>
          </div>
        ) : (
